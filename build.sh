pushd build/lin
clang -g -rdynamic -o practice -DSTB_IMAGE_IMPLEMENTATION ../../src/main.c -I../../../cglm/include -I../../../freetype/include -I../../../SDL/include -I../../../glad/include -I../JoltPhysics-5.3.0 -L../../lib/lin -lJolt -ldl -lSDL3 -lm
